...
type Station struct {
	...
	Mobile     string    `gorm:"column:mobile;type:varchar(255);comment:油站号码;NOT NULL" json:"mobile"`
...
type Oil struct {
	...
	Price      float64   `gorm:"column:price;type:double unsigned;default:0;comment:单价/元;NOT NULL" json:"price"`
	IsDelete   int       `gorm:"column:is_delete;type:tinyint(4);default:0;comment:是否删除;NOT NULL" json:"is_delete"`
	CreateTime time.Time `gorm:"->" json:"create_time"`
	UpdateTime time.Time `gorm:"->" json:"update_time"`
}
...
type Record struct {
	...
	Price       float64   `gorm:"column:price;type:double unsigned;default:0;comment:单价/元;NOT NULL" json:"price"`
	Liter       float64   `gorm:"column:liter;type:double unsigned;default:0;comment:数量/升;NOT NULL" json:"liter"`
	Amount      float64   `gorm:"column:amount;type:double unsigned;default:0;comment:总价/元;NOT NULL" json:"amount"`
